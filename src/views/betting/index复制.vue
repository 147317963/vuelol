<template>
    <div class="betting-page router-view" >
        ...
        <section class="betting-stage" style="height: calc(100% - 164px);">
            ...
            <van-tabs  ref="tabs" @change="indexChange" v-model="active"  swipeable animated   line-width="48" title-active-color="#ffffff" title-inactive-color="rgb(186, 206, 241)" background="#0c121f"  style="height:100%;" >



                <van-tab :title="'全场 ' + 1" title-style="font-size: 1.2rem;font-weight:400;">
