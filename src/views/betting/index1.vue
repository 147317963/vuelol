        ...
        <section class="betting-info">
            <section class="info-title">
                <img alt="英雄联盟" width="20px"
                     ...
                     lazy="loaded">
                <div class="tournament-name">LPL夏季赛</div>
                <div class="match-round">&nbsp;/ BO3</div>
            </section>
            <section class="info-team">
                <div class="team-info"><img class="team-logo"
                                            data-src="//www.nmgdjkj.com//file/2a4794180b15b03692d8f08fa938b21e.png"
                                            src="//www.nmgdjkj.com//file/2a4794180b15b03692d8f08fa938b21e.png"
                                            lazy="loaded">
                    <div class="team-name">WE</div>
                </div>
                <div class="betting-status">
                    <div class="status-early">
                        <div class="is-early">
                            <div class="match-date">6月 07日 周日</div>
                            <div class="match-time">17:00</div>
                        </div>
                    </div>
                    <div class="is-raedy">未开始</div>
                </div>
                <div class="team-info"><img class="team-logo"
                                            data-src="//www.nmgdjkj.com//file/bcaa386bbcef5c68cb078f38062c2cbe.png"
                                            src="//www.nmgdjkj.com//file/bcaa386bbcef5c68cb078f38062c2cbe.png"
                                            lazy="loaded">
                    <div class="team-name">SN</div>
                </div>
            </section>
        </section>
            ...
            <section class="betting-stage" style="height: calc(100% - 164px);" >
                ...
                <van-tabs  ref="tabs" v-model="active"  scrollspy sticky   line-width="48" title-active-color="#ffffff" title-inactive-color="rgb(186, 206, 241)" background="#0c121f"  style="height:100%;overflow-y: auto;" >


                    <van-tab  v-for="index in 6" :title="'全场 ' + index" title-style="font-size: 1.2rem;font-weight:400;">
                        <section class="betting-odds">
                            ...
                            <div class="group-list">
                                <div class="odds-group-title odds-group-title">
                                    ...
                                    <div class="title">获胜者</div>
                                </div>
                                <div class="group-odds">
                                    <div class="match-card-button odds-btn btn-locked">
                                        <div class="button-dark-border">
                                            <div class="button-content btn-left">
                                    ...
                                    <div class="match-card-button odds-btn btn-locked">
                                        <div class="button-dark-border">
                                            <div class="button-content btn-right">
                                                <div class="button-odds-content">
                                                    <div class="btn-odds"></div>
                                                    <div class="odds-rising-icon"></div>
                                                    <div class="odds-dropping-icon"></div>
                                ...
                                <div class="group-odds">
                                        ...
                                        <div class="button-dark-border">
                                            <div class="button-content btn-left">
                                                ...
                                                <div class="button-odds-content">
                                                    <div class="odds-rising-icon"></div>
                                                    <div class="odds-dropping-icon"></div>
                                                    <div class="btn-odds"><span>2.66</span></div>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="match-card-button odds-btn">
                                        <div class="button-dark-border">
                                            <div class="button-content btn-right">
                                                <div class="button-odds-content">
                                                    <div class="btn-odds"><span>4.00</span></div>
                                                    <div class="odds-rising-icon"></div>
                                                    <div class="odds-dropping-icon"></div>
                                                </div>
                                                <div class="button-name">
                                        ...
                                        <div class="button-dark-border">
                                            <div class="button-content btn-left">
                                                ...
                                                <div class="button-odds-content">
                                                    <div class="odds-rising-icon"></div>
                                                    <div class="odds-dropping-icon"></div>
                                                    <div class="btn-odds"><span>2.94</span></div>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="match-card-button odds-btn">
                                        <div class="button-dark-border">
                                            <div class="button-content btn-right">
                                                <div class="button-odds-content">
                                                    <div class="btn-odds"><span>3.50</span></div>
                                                    <div class="odds-rising-icon"></div>
                                                    <div class="odds-dropping-icon"></div>
                                                </div>
                                                <div class="button-name">
                                ...
                                <div class="group-odds">
                                        ...
                                        <div class="button-dark-border">
                                            <div class="button-content btn-left">
                                                ...
                                                <div class="button-odds-content">
                                                    <div class="odds-rising-icon"></div>
                                                    <div class="odds-dropping-icon"></div>
                                                    <div class="btn-odds"><span>2.71</span></div>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="match-card-button odds-btn">
                                        <div class="button-dark-border">
                                            <div class="button-content btn-right">
                                                <div class="button-odds-content">
                                                    <div class="btn-odds"><span>1.44</span></div>
                                                    <div class="odds-rising-icon"></div>
                                                    <div class="odds-dropping-icon"></div>
                                                </div>
                                                <div class="button-name">
                                ...
                                <div class="group-odds">
                                        ...
                                        <div class="button-dark-border">
                                            <div class="button-content btn-left">
                                                ...
                                                <div class="button-odds-content">
                                                    <div class="odds-rising-icon"></div>
                                                    <div class="odds-dropping-icon"></div>
                                                    <div class="btn-odds"><span>1.98</span></div>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="match-card-button odds-btn">
                                        <div class="button-dark-border">
                                            <div class="button-content btn-right">
                                                <div class="button-odds-content">
                                                    <div class="btn-odds"><span>1.79</span></div>
                                                    <div class="odds-rising-icon"></div>
                                                    <div class="odds-dropping-icon"></div>
                                                </div>
                                                <div class="button-name">
                ...
                <!--                            第二局-->
                <!--                        </div>-->
                <!--                        <div class="vux-tab-item vux-tab-disabled" style="border: none;">&nbsp;-->
                <!--                        </div>-->
                <!--                        <div class="vux-tab-item vux-tab-disabled" style="border: none;">&nbsp;-->
                <!--                        </div>-->
                <!--                        <div class="vux-tab-item vux-tab-disabled" style="border: none;">&nbsp;-->
...
<style lang="less" >
    ...
    .betting-page .vux-tab-container {
