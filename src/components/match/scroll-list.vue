            ...
            <transition name="fade">
                <div v-show="!matchRefresh">
                    <template v-for="(item)  in matchList">
                        <div class="home-match-card" v-show="Object.values(gameList).length && gameList[item['game_id']]['selected']" :key="item.id"
                             @click.stop="$router.push({path:'/betting/'+item['id']})"
                        >

                            <section class="card-header">
                                <!--                游戏logo-->
                                <img style="width: 20px"
                                     v-lazy="Object.values(gameList).length && Object.keys(configList).length ? configList['img_url']['value']+gameList[item['game_id']]['logo']:''">
                                <!--                跳转到当前赛季列表-->
                            ...
                            <section class="card-body">
                                <div class="card-body-team">
                                    <img class="team-logo"
                                         v-lazy="Object.values(gameList).length && Object.keys(configList).length ? configList['img_url']['value']+item['team'][_.findIndex(item['team'],{'pos':1})]['team_logo']:''">
                                </div>
                                <div class="card-body-center">
                                    ...
                                    <img src="data:image/svg+xml;base64,"
                                         class="center-left">
                                    <!--                                比分-->
                                    <div class="team-score" v-if="item['status'] === matchStatus['滚盘中']['status'] ">
                                        <div class="score left-score">
                                            {{item['team'][_.findIndex(item['team'],{'pos':1})]['score']['total']||0}}
                                        </div>
                                        <div class="dash-symbol">-</div>
                                        <div class="score right-score">
                                            {{item['team'][_.findIndex(item['team'],{'pos':2})]['score']['total']||0}}
                                        </div>
                                    </div>
                                    <!--                                开始时间-->
                                    <div class="start-time" v-if="item['status'] === matchStatus['未开始']['status'] ">
                                        {{item['start_time'].substr(11,5)}}
                                ...
                                <div class="card-body-team">
                                    <img class="team-logo"
                                         v-lazy="Object.values(gameList).length && Object.keys(configList).length ? configList['img_url']['value']+item['team'][_.findIndex(item['team'],{'pos':2})]['team_logo']:''">
                                </div>
                            ...
                            <div class="odds-group-title">
                                <template v-if="item['odds']">
                                    ...
                                    <template v-if="item['odds']">
                                        <div class="title" v-for="(match_stage,index) in _.groupBy(item['odds'], 'match_stage')" :key="index">{{matchStage[index]['name']}} {{item['odds'][0]['group_name']}}</div>
                                    </template>

                                </template>
                            </div>
                            <section class="card-footer">
                                <!--                                _.findKey(item['team'],{'pos':1})-->
                                <!--                                <template v-for="(items,indexs)  in item['odds']">-->
                                <div class="card-odds-btn"
                                     @click.stop="
item['odds'] ?selected(_.sortBy(item['odds'], function(o) { return o.id; })[0]):''">
                                    <div class="match-card-button"
                                         :class="[
                                         item['odds']?addClass('btn-selected',_.sortBy(item['odds'], function(o) { return o.id; })[0]):'',
                                         item['odds']?addClass('btn-locked',_.sortBy(item['odds'], function(o) { return o.id; })[0]):'',
                                         item['odds']?addClass('btn-over',_.sortBy(item['odds'], function(o) { return o.id; })[0]):'btn-over',
                                         item['odds']?_.sortBy(item['odds'], function(o) { return o.id; })[0]['tag']:'',
                                     ]">
<!--                                        btn-odds-dropping-->
...
<!--                                                {{item['odds'][_.findIndex(item['odds'],{name:item['team'][_.findIndex(item['team'],{'pos':1})]['team_name']})]}}-->
                                                ...
                                                <div class="button-name">
                                                    {{item['team'][_.findIndex(item['team'],{'pos':1})]['team_name']}}
                                                </div>
                                                <!--                              !==oddsStatus['已结算']['status']          已经结算不会显示赔率-->
                                                <div class="button-odds-content"
                                                     v-if="item['odds']? _.sortBy(item['odds'], function(o) { return o.id; })[0]['status'] !==oddsStatus['已结束']['status']:false">
                                                    <!--                                                    >-->
                                                    <div class="odds-rising-icon"></div>
                                                    <div class="btn-odds">
                                                            <span v-if="item['odds']? _.sortBy(item['odds'], function(o) { return o.id; })[0]['status'] !==oddsStatus['已封盘']['status']:false">
                                                                {{_.sortBy(item['odds'], function(o) { return o.id; })[0]['odds']}}
                                                            </span>
                                                    </div>
                                ...
                                <div class="match-status">
                                    <div
                                            :class="[
                              addClass('status-early',item),
                             addClass('status-live',item),
                             addClass('status-over',item),
                         ]"
                                    >


                                    </div>
                                    <div  class="match-is-early" v-if=" item['status'] === matchStatus['未开始']['status']">
                                        <div  class="status-icon early-icon"></div>
                                        <div  class="match-status-text">{{matchStatus['未开始']['name']}}</div>
                                    </div>

                                    <div class="match-is-live" v-if=" item['status'] === matchStatus['滚盘中']['status']">
                                ...
                                <div class="card-odds-btn"
                                     @click.stop="
                                     item['odds'] ?selected(_.sortBy(item['odds'], function(o) { return o.id; })[1]):''">
                                    <div class="match-card-button"
                                         :class="[
                                         item['odds']?addClass('btn-selected',_.sortBy(item['odds'], function(o) { return o.id; })[1]):'',
                                         item['odds']?addClass('btn-locked',_.sortBy(item['odds'], function(o) { return o.id; })[1]):'',
                                         item['odds']?addClass('btn-over',_.sortBy(item['odds'], function(o) { return o.id; })[1]):'btn-over',
                                         item['odds']?_.sortBy(item['odds'], function(o) { return o.id; })[1]['tag']:'',
                                         // item['odds']?item['odds'][_.findIndex(item['odds'],{name:item['team'][_.findIndex(item['team'],{'pos':2})]['team_name']})]['tag']:''
                                     ]">
                                        <div class="button-dark-border">
                                            <div class="button-content">
                                                <!--                                <div class="button-name">{{item['team'][0]['team_name']}}</div>-->
                                                <div class="button-name">
                                                    {{item['team'][_.findIndex(item['team'],{'pos':2})]['team_name']}}
                                                </div>
                                                <!--                              !==oddsStatus['已结算']['status']          已经结算不会显示赔率-->


                                                <div class="button-odds-content"
                                                     v-if="item['odds']? _.sortBy(item['odds'], function(o) { return o.id; })[1]['status'] !==oddsStatus['已结束']['status']:false">
                                                    <!--                                                    >-->
                                                    <div class="odds-rising-icon"></div>
                                                    <div class="btn-odds">
                                                            <span v-if="item['odds']? _.sortBy(item['odds'], function(o) { return o.id; })[1]['status'] !==oddsStatus['已封盘']['status']:false">
                                                                {{_.sortBy(item['odds'], function(o) { return o.id; })[1]['odds']}}
                                                            </span>
                                                    </div>
                                                    <div class="odds-dropping-icon"></div>
                                                </div>
<!--                                                <div class="button-odds-content"-->
<!--                                                     v-if="item['odds']? item['odds'][_.findIndex(item['odds'],{name:item['team'][_.findIndex(item['team'],{'pos':2})]['team_name']})]['status'] !==oddsStatus['已结束']['status']:false">-->
<!--                                                    &lt;!&ndash;                                                    >&ndash;&gt;-->
<!--                                                    <div class="odds-rising-icon"></div>-->
<!--                                                    <div class="btn-odds">-->
<!--                                                            <span v-if="item['odds']? item['odds'][_.findIndex(item['odds'],{name:item['team'][_.findIndex(item['team'],{'pos':2})]['team_name']})]['status'] !==oddsStatus['已封盘']['status']:false">-->
<!--                                                                {{item['odds'][_.findIndex(item['odds'],{name:item['team'][_.findIndex(item['team'],{'pos':2})]['team_name']})]['odds']}}-->
<!--                                                            </span>-->
<!--                                                    </div>-->
<!--                                                    <div class="odds-dropping-icon"></div>-->
<!--                                                </div>-->
